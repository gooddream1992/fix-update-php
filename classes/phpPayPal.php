...
class phpPayPal { 
	...
	*/
	...
	/**
	  ...
	  * @param String $methName is name of API  method.
	  * @param String $nvpStr is nvp string.
	  * @return Array an associtive array containing the response from the server. returns false on error
	  * @access private
	*/
	private function hash_call($methName, $nvpStr)
	{
	   ...
	   //Set proxy name to PROXY_HOST and port number to PROXY_PORT in constants.php 
		...
		$nvpreq = "METHOD=".urlencode($methName)."&VERSION=".urlencode($this->VERSION)."&PWD=".urlencode($this->API_PASSWORD).
