 ...
 * @method     BusinessUserQuery orderByIsDefault($order = Criteria::ASC) Order by the is_default column
 ...
 * @method     BusinessUserQuery groupByIsDefault() Group by the is_default column
 ...
 * @method     BusinessUser findOneByIsDefault(int $is_default) Return the first BusinessUser filtered by the is_default column
 ...
 * @method     array findByIsDefault(int $is_default) Return BusinessUser objects filtered by the is_default column
...
abstract class BaseBusinessUserQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'sigfly', $modelName = 'BusinessUser', $modelAlias = null)
	{
	 ...
	 * 
	 * @param     int|array $isDefault The value to use as filter.
	 *            Accepts an associative array('min' => $minValue, 'max' => $maxValue)
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    BusinessUserQuery The current query, for fluid interface
	...
	public function filterByIsDefault($isDefault = null, $comparison = null)
	{
		if (is_array($isDefault)) {
			...
			if (isset($isDefault['min'])) {
				$this->addUsingAlias(BusinessUserPeer::IS_DEFAULT, $isDefault['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($isDefault['max'])) {
				$this->addUsingAlias(BusinessUserPeer::IS_DEFAULT, $isDefault['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(BusinessUserPeer::IS_DEFAULT, $isDefault, $comparison);
	}
