...
abstract class BaseBlog extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the http_host field.
	...
	/**
	 * The value for the xmlrpc_script field.
	 * @var        string
	 */
	protected $xmlrpc_script;
	...
	/**
	 * Get the [http_host] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [xmlrpc_script] column value.
	 * 
	 * @return     string
	 */
	public function getXmlrpcScript()
	{
		return $this->xmlrpc_script;
	}
	...
	/**
	 * Set the value of [http_host] column.
	 * 
	...
	public function setHttpHost($v)
	{
		...
		if ($this->http_host !== $v || $this->isNew()) {
			$this->http_host = $v;
			$this->modifiedColumns[] = BlogPeer::HTTP_HOST;
		}
	...
	public function setDateCreated($v)
	{
		...
		if ( $this->date_created !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = BlogPeer::DATE_CREATED;
			}
	...
	public function setDateModified($v)
	{
		...
		if ( $this->date_modified !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = BlogPeer::DATE_MODIFIED;
			}
		} // if either are not null
	...
	public function setIsActive($v)
	{
		...
		if ($this->is_active !== $v) {
			$this->is_active = $v;
			$this->modifiedColumns[] = BlogPeer::IS_ACTIVE;
		}
	...
	public function setUsername($v)
	{
		...
		if ($this->username !== $v) {
			$this->username = $v;
			$this->modifiedColumns[] = BlogPeer::USERNAME;
		}
	...
	public function setPassword($v)
	{
		...
		if ($this->password !== $v) {
			$this->password = $v;
			$this->modifiedColumns[] = BlogPeer::PASSWORD;
		}
	...
	/**
	 * Set the value of [xmlrpc_script] column.
	 * 
	 * @param      string $v new value
	 * @return     Blog The current object (for fluent API support)
	 */
	public function setXmlrpcScript($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->xmlrpc_script !== $v) {
			$this->xmlrpc_script = $v;
			$this->modifiedColumns[] = BlogPeer::XMLRPC_SCRIPT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->http_host = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			...
			$this->xmlrpc_script = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->resetModified();
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[7], $arr)) $this->setXmlrpcScript($arr[$keys[7]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(BlogPeer::HTTP_HOST)) $criteria->add(BlogPeer::HTTP_HOST, $this->http_host);
		if ($this->isColumnModified(BlogPeer::DATE_CREATED)) $criteria->add(BlogPeer::DATE_CREATED, $this->date_created);
		if ($this->isColumnModified(BlogPeer::DATE_MODIFIED)) $criteria->add(BlogPeer::DATE_MODIFIED, $this->date_modified);
		if ($this->isColumnModified(BlogPeer::IS_ACTIVE)) $criteria->add(BlogPeer::IS_ACTIVE, $this->is_active);
		if ($this->isColumnModified(BlogPeer::USERNAME)) $criteria->add(BlogPeer::USERNAME, $this->username);
		if ($this->isColumnModified(BlogPeer::PASSWORD)) $criteria->add(BlogPeer::PASSWORD, $this->password);
		if ($this->isColumnModified(BlogPeer::XMLRPC_SCRIPT)) $criteria->add(BlogPeer::XMLRPC_SCRIPT, $this->xmlrpc_script);
	...
	{
		$copyObj->setHttpHost($this->http_host);
		$copyObj->setDateCreated($this->date_created);
		$copyObj->setDateModified($this->date_modified);
		$copyObj->setIsActive($this->is_active);
		$copyObj->setUsername($this->username);
		$copyObj->setPassword($this->password);
		$copyObj->setXmlrpcScript($this->xmlrpc_script);
