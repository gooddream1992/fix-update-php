...
abstract class BaseSession extends BaseObject  implements Persistent
{
	...
	public function setSid($v)
	{
		...
		if ($this->sid !== $v || $this->isNew()) {
			$this->sid = $v;
			$this->modifiedColumns[] = SessionPeer::SID;
		}
	...
	public function setVariable($v)
	{
		...
		if ($this->variable !== $v || $this->isNew()) {
			$this->variable = $v;
			$this->modifiedColumns[] = SessionPeer::VARIABLE;
		}
	...
	public function setValue($v)
	{
		...
		if ($this->value !== $v) {
			$this->value = $v;
			$this->modifiedColumns[] = SessionPeer::VALUE;
		}
	...
	public function setTimestamp($v)
	{
		...
		if ( $this->timestamp !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = SessionPeer::TIMESTAMP;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->variable = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 5; // 5 = SessionPeer::NUM_COLUMNS - SessionPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setVariable($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SessionPeer::SID)) $criteria->add(SessionPeer::SID, $this->sid);
		if ($this->isColumnModified(SessionPeer::VARIABLE)) $criteria->add(SessionPeer::VARIABLE, $this->variable);
		if ($this->isColumnModified(SessionPeer::VALUE)) $criteria->add(SessionPeer::VALUE, $this->value);
		if ($this->isColumnModified(SessionPeer::TIMESTAMP)) $criteria->add(SessionPeer::TIMESTAMP, $this->timestamp);
