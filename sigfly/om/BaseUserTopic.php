...
/**
 * Base class that represents a row from the 'user_topic' table.
 *
 * 
 *
 * @package    propel.generator.sigfly.om
 */
abstract class BaseUserTopic extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'UserTopicPeer';
	...
	/**
	 * Initializes internal state of BaseUserTopic object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     UserTopic The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = UserTopicPeer::ID;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v || $this->isNew()) {
			$this->user_id = $v;
			$this->modifiedColumns[] = UserTopicPeer::USER_ID;
		}
	...
	public function setSubject($v)
	{
		...
		if ($this->subject !== $v || $this->isNew()) {
			$this->subject = $v;
			$this->modifiedColumns[] = UserTopicPeer::SUBJECT;
		}
	...
	public function setContent($v)
	{
		...
		if ($this->content !== $v) {
			$this->content = $v;
			$this->modifiedColumns[] = UserTopicPeer::CONTENT;
		}
	...
	public function setDateCreated($v)
	{
		...
		if ( $this->date_created !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = UserTopicPeer::DATE_CREATED;
			}
	...
	public function setIsActive($v)
	{
		...
		if ($this->is_active !== $v || $this->isNew()) {
			$this->is_active = $v;
			$this->modifiedColumns[] = UserTopicPeer::IS_ACTIVE;
		}
	...
	/**
	 * Set the value of [is_answered] column.
	 * 
	 * @param      int $v new value
	 * @return     UserTopic The current object (for fluent API support)
	 */
	public function setIsAnswered($v)
	{
		...
		if ($this->is_answered !== $v || $this->isNew()) {
			$this->is_answered = $v;
			$this->modifiedColumns[] = UserTopicPeer::IS_ANSWERED;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->is_answered = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			$this->resetModified();
			...
			return $startcol + 7; // 7 = UserTopicPeer::NUM_COLUMNS - UserTopicPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating UserTopic object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = UserTopicPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				UserTopicPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(UserTopicPeer::ID) ) {
					...
					$affectedRows += UserTopicPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = UserTopicPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = UserTopicPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = UserTopicPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UserTopicPeer::ID)) $criteria->add(UserTopicPeer::ID, $this->id);
		if ($this->isColumnModified(UserTopicPeer::USER_ID)) $criteria->add(UserTopicPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(UserTopicPeer::SUBJECT)) $criteria->add(UserTopicPeer::SUBJECT, $this->subject);
		if ($this->isColumnModified(UserTopicPeer::CONTENT)) $criteria->add(UserTopicPeer::CONTENT, $this->content);
		if ($this->isColumnModified(UserTopicPeer::DATE_CREATED)) $criteria->add(UserTopicPeer::DATE_CREATED, $this->date_created);
		if ($this->isColumnModified(UserTopicPeer::IS_ACTIVE)) $criteria->add(UserTopicPeer::IS_ACTIVE, $this->is_active);
		if ($this->isColumnModified(UserTopicPeer::IS_ANSWERED)) $criteria->add(UserTopicPeer::IS_ANSWERED, $this->is_answered);
	...
	{
		$criteria = new Criteria(UserTopicPeer::DATABASE_NAME);
		$criteria->add(UserTopicPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of UserTopic (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIsAnswered($this->is_answered);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     UserTopic Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     UserTopicPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new UserTopicPeer();
		}
		return self::$peer;
	}
	 ...
	 * If this UserTopic is new, it will return
	 ...
	 * Otherwise if this UserTopic is new, it will return
	 * an empty collection; or if this UserTopic has previously
	 * been saved, it will retrieve related UserThreads from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in UserTopic.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 ...
	 * @return     PropelCollection|array UserThread[] List of UserThread objects
	 */
	public function getUserThreadsJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = UserThreadQuery::create(null, $criteria);
