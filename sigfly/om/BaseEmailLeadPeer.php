...
abstract class BaseEmailLeadPeer {
	...
	const CLASS_DEFAULT = 'sigfly.EmailLead';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Email', 'Zipcode', 'DateCreated', 'RemoteAddr', 'IsActive', 'AffiliateId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'email', 'zipcode', 'dateCreated', 'remoteAddr', 'isActive', 'affiliateId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::EMAIL, self::ZIPCODE, self::DATE_CREATED, self::REMOTE_ADDR, self::IS_ACTIVE, self::AFFILIATE_ID, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'EMAIL', 'ZIPCODE', 'DATE_CREATED', 'REMOTE_ADDR', 'IS_ACTIVE', 'AFFILIATE_ID', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'email', 'ZIPCode', 'date_created', 'remote_addr', 'is_active', 'affiliate_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Email' => 1, 'Zipcode' => 2, 'DateCreated' => 3, 'RemoteAddr' => 4, 'IsActive' => 5, 'AffiliateId' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'email' => 1, 'zipcode' => 2, 'dateCreated' => 3, 'remoteAddr' => 4, 'isActive' => 5, 'affiliateId' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::EMAIL => 1, self::ZIPCODE => 2, self::DATE_CREATED => 3, self::REMOTE_ADDR => 4, self::IS_ACTIVE => 5, self::AFFILIATE_ID => 6, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'EMAIL' => 1, 'ZIPCODE' => 2, 'DATE_CREATED' => 3, 'REMOTE_ADDR' => 4, 'IS_ACTIVE' => 5, 'AFFILIATE_ID' => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'email' => 1, 'ZIPCode' => 2, 'date_created' => 3, 'remote_addr' => 4, 'is_active' => 5, 'affiliate_id' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
