...
/**
 * Skeleton subclass for representing a row from the 'pricing_detail_default' table.
 *
 * 
 *
 ...
 */
class PricingDetailDefault extends BasePricingDetailDefault {
