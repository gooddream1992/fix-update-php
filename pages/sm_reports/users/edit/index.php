...
<table width="95%" border="0">
	...
	<tr>
		<td class="mainText"><b>Affiliate Id</b></td>
		<td class="mainText"><?=$WorkingUser->getDefaultBusiness()->getId();?></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="mainText"><b>Accounting/Current Balance</b></td>
		<td class="mainText">USD$ <?php echo number_format(DealFeedCommissionQuery::getCurrentCommissions($WorkingUser),2);?></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="mainText"><b>Last Login Date</b></td>
		<td class="mainText"><?=$WorkingUser->getLastLoginDate();?> </td>
	</tr>
<?
