...
<table width="95%" border="0">
	...
	<tr>
		<td><input type="text" name="s"><input type="submit" value=" Search Advertisers "></td>
	</tr>
...
if($_GET['type'] != 'cc') {
	...
	echo "<b>Advertisers Needing Wilshire Logins</b>";
	...
	echo "<b>Advertisers Expired and/or Expiring Soon</b>";
