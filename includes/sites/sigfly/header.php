...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml" xmlns:og="http://opengraphprotocol.org/schema/" class=''>
	<head profile="http://gmpg.org/xfn/11">
		...
		<META NAME="author" CONTENT="Sigfly, Inc.">
		...
		*/ ?>
		...
		<link href="/includes/css/sigfly/layout.css" rel="stylesheet" type="text/css" />
		<?php  /* */ ?>
		<!-- Cufon -->
		<script type="text/javascript" src="/includes/js/sigfly/cufon-yui.js"></script>
		<script type="text/javascript" src="/includes/js/sigfly/myradpro.font.js"></script>
