...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml" xmlns:og="http://opengraphprotocol.org/schema/" class=''>
	<head profile="http://gmpg.org/xfn/11">
		...
		<link rel="alternate" type="application/rss+xml" title="FiveDeals &raquo; Feed" href="http://<?php echo $_SERVER['HTTP_HOST'];?>/index/rss" />
		...
		<META NAME="author" CONTENT="Fivedeals.co">
		...
		*/ ?>
		<link href="/includes/css/fivedeals/fb_style.css" rel="stylesheet" type="text/css">
		<link href="/includes/css/fivedeals/layout.css" rel="stylesheet" type="text/css" />
		<?php  /*
		<!-- Cufon -->
		<script type="text/javascript" src="/includes/js/fivedeals/cufon-yui.js"></script>
		<script type="text/javascript" src="/includes/js/fivedeals/myradpro.font.js"></script>
		<script type="text/javascript">
		Cufon.replace('h1')('h2')('h3')('h4')('table th');
		</script> */ ?>
