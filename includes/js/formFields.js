...
'F','Miss'
	...
	var advertising_objective = new Array(
'--','--Select One--'
);
	var primary_target = new Array(
'--','--Select One--'
);
	var advertising_timeline = new Array(
'--','--Select One--'
);
	var lead_source = new Array(
'--','--Select One--'
);	

	var budget_monthly = new Array(
'--','--Select One--',
'$0-$5,000','$0-$5,000',
...
'XX','-- Other'
	...
	this.elem['company'] = new Array("Company Name",'','text','20','80');
	this.elem['URL'] = new Array("Company URL",'','text','20','80');
	this.elem['products'] = new Array("Product(s) / Service(s) Offered",'','text','20','80');
	this.elem['first_name'] = new Array("First Name",'','text','20','20');
	this.elem['last_name'] = new Array("Last Name",'','text','20','20');
	
	this.elem['title'] = new Array("Job Title",'','text','20','80');
	this.elem['email'] = new Array("eMail",'','text','20','80');
	this.elem['street'] = new Array("Address",'','text','20','127');
	this.elem['city'] = new Array("City",'','text','20','50');
	this.elem['state'] = new Array("State/Province",'','select',state);
	
	this.elem['zip'] = new Array("Zip Code",'','text','10','10');
	this.elem['country'] = new Array("Country",'','text','10','10');
	this.elem['phone'] = new Array("Telephone Number",'','text','12','15');
	this.elem['objective'] = new Array("Primary Advertising Objective",'','select',advertising_objective);
	this.elem['Target'] = new Array("Primary Target",'','select',primary_target);
	
	this.elem['budget'] = new Array("Approximate Monthly Budget",'','select',budget_monthly);
	this.elem['advertise'] = new Array("When are you ready to advertise",'','select',advertising_timeline);
	this.elem['lead_source'] = new Array("How did you hear about us",'','select',lead_source);
	this.elem['information'] = new Array("Other Information",'','text','20','255');
	...
	this.validate['company'] = notMissing;
	this.validate['URL'] = notMissing;
	this.validate['products'] = notMissing;
	this.validate['first_name'] = notMissing;
	this.validate['last_name'] = notMissing;
	
	this.validate['title'] = notMissing;
	this.validate['email'] = validateEmail;
	this.validate['street'] = notMissing;
	this.validate['city'] = notMissing;
	this.validate['state'] = validateState;
	
	this.validate['zip'] = notMissing;
	this.validate['country'] = notMissing;
	this.validate['phone'] = validatePhone;
	this.validate['objective'] = validateAdvertisingObjective;
	this.validate['target'] = validatePrimaryTarget;
	
	this.validate['budget'] = validateBudgetMonthly;
	this.validate['advertise'] = validateAdvertisingTimeline;
	this.validate['lead_source'] = validateLeadSource;
	this.validate['information'] = notMissing;
...
function validateBudgetMonthly(elem)
{
	var result = false;
	value = elem.value + "";
...
function validateAdvertisingObjective(elem)
{
	var result = false;
	value = elem.value + "";
	if (value != "--") {result = true;}
...
function validatePrimaryTarget(elem)
{
	var result = false;
	value = elem.value + "";
	if (value != "--") {result = true;}
...
function validateAdvertisingTimeline(elem)
{
	var result = false;
	value = elem.value + "";
	if (value != "--") {result = true;}
...
function validateLeadSource(elem)
{
	var result = false;
	value = elem.value + "";
	if (value != "--") {result = true;}
