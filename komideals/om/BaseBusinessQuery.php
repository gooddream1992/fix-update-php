 ...
 *
 * @method     BusinessQuery leftJoinDeal($relationAlias = null) Adds a LEFT JOIN clause to the query using the Deal relation
 * @method     BusinessQuery rightJoinDeal($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Deal relation
 * @method     BusinessQuery innerJoinDeal($relationAlias = null) Adds a INNER JOIN clause to the query using the Deal relation
 *
 * @method     BusinessQuery leftJoinDealFeed($relationAlias = null) Adds a LEFT JOIN clause to the query using the DealFeed relation
 * @method     BusinessQuery rightJoinDealFeed($relationAlias = null) Adds a RIGHT JOIN clause to the query using the DealFeed relation
 * @method     BusinessQuery innerJoinDealFeed($relationAlias = null) Adds a INNER JOIN clause to the query using the DealFeed relation
 *
 * @method     BusinessQuery leftJoinDealFeedClick($relationAlias = null) Adds a LEFT JOIN clause to the query using the DealFeedClick relation
 * @method     BusinessQuery rightJoinDealFeedClick($relationAlias = null) Adds a RIGHT JOIN clause to the query using the DealFeedClick relation
 * @method     BusinessQuery innerJoinDealFeedClick($relationAlias = null) Adds a INNER JOIN clause to the query using the DealFeedClick relation
 *
 * @method     BusinessQuery leftJoinDealFeedCommission($relationAlias = null) Adds a LEFT JOIN clause to the query using the DealFeedCommission relation
 * @method     BusinessQuery rightJoinDealFeedCommission($relationAlias = null) Adds a RIGHT JOIN clause to the query using the DealFeedCommission relation
 * @method     BusinessQuery innerJoinDealFeedCommission($relationAlias = null) Adds a INNER JOIN clause to the query using the DealFeedCommission relation
 *
 * @method     BusinessQuery leftJoinDealFeedStat($relationAlias = null) Adds a LEFT JOIN clause to the query using the DealFeedStat relation
 * @method     BusinessQuery rightJoinDealFeedStat($relationAlias = null) Adds a RIGHT JOIN clause to the query using the DealFeedStat relation
 * @method     BusinessQuery innerJoinDealFeedStat($relationAlias = null) Adds a INNER JOIN clause to the query using the DealFeedStat relation
 *
 * @method     BusinessQuery leftJoinDealFeedView($relationAlias = null) Adds a LEFT JOIN clause to the query using the DealFeedView relation
 * @method     BusinessQuery rightJoinDealFeedView($relationAlias = null) Adds a RIGHT JOIN clause to the query using the DealFeedView relation
 * @method     BusinessQuery innerJoinDealFeedView($relationAlias = null) Adds a INNER JOIN clause to the query using the DealFeedView relation
 *
...
abstract class BaseBusinessQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'komideals', $modelName = 'Business', $modelAlias = null)
	{
	...
	{
		return $this
			->addUsingAlias(BusinessPeer::ID, $deal->getBusinessId(), $comparison);
	}
	...
	{
		return $this
			->addUsingAlias(BusinessPeer::ID, $dealFeed->getBusinessId(), $comparison);
	}
	...
	{
		return $this
			->addUsingAlias(BusinessPeer::ID, $dealFeedClick->getBusinessId(), $comparison);
	}
	...
	{
		return $this
			->addUsingAlias(BusinessPeer::ID, $dealFeedCommission->getBusinessId(), $comparison);
	}
	...
	{
		return $this
			->addUsingAlias(BusinessPeer::ID, $dealFeedStat->getBusinessId(), $comparison);
	}
	...
	/**
	 * Filter the query by a related DealFeedView object
	 *
	 * @param     DealFeedView $dealFeedView  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    BusinessQuery The current query, for fluid interface
	 */
	public function filterByDealFeedView($dealFeedView, $comparison = null)
	{
		return $this
			->addUsingAlias(BusinessPeer::ID, $dealFeedView->getBusinessId(), $comparison);
	}

	/**
	 * Adds a JOIN clause to the query using the DealFeedView relation
	 * 
	 * @param     string $relationAlias optional alias for the relation
	 * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
	 *
	 * @return    BusinessQuery The current query, for fluid interface
	 */
	public function joinDealFeedView($relationAlias = null, $joinType = Criteria::INNER_JOIN)
	{
		$tableMap = $this->getTableMap();
		$relationMap = $tableMap->getRelation('DealFeedView');
		...
		if($relationAlias) {
			...
			$this->addJoinObject($join, 'DealFeedView');
		}
	...
	/**
	 * Use the DealFeedView relation DealFeedView object
	 *
	 * @see       useQuery()
	 * 
	 * @param     string $relationAlias optional alias for the relation,
	 ...
	 * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
	 *
	 * @return    DealFeedViewQuery A secondary query class using the current class as primary query
	 */
	public function useDealFeedViewQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
	{
		return $this
			->joinDealFeedView($relationAlias, $joinType)
			->useQuery($relationAlias ? $relationAlias : 'DealFeedView', 'DealFeedViewQuery');
	}
