...
abstract class BasePurchaseOrder extends BaseObject  implements Persistent
{
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v || $this->isNew()) {
			$this->user_id = $v;
			$this->modifiedColumns[] = PurchaseOrderPeer::USER_ID;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v || $this->isNew()) {
			$this->description = $v;
			$this->modifiedColumns[] = PurchaseOrderPeer::DESCRIPTION;
		}
	...
	public function setDateCreated($v)
	{
		...
		if ( $this->date_created !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PurchaseOrderPeer::DATE_CREATED;
			}
	...
	public function setDatePaid($v)
	{
		...
		if ( $this->date_paid !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PurchaseOrderPeer::DATE_PAID;
			}
		} // if either are not null
	...
	public function setIsActive($v)
	{
		...
		if ($this->is_active !== $v || $this->isNew()) {
			$this->is_active = $v;
			$this->modifiedColumns[] = PurchaseOrderPeer::IS_ACTIVE;
		}
	...
	public function setIsPaid($v)
	{
		...
		if ($this->is_paid !== $v || $this->isNew()) {
			$this->is_paid = $v;
			$this->modifiedColumns[] = PurchaseOrderPeer::IS_PAID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->date_paid = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->is_active = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->is_paid = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			$this->resetModified();
			...
			return $startcol + 7; // 7 = PurchaseOrderPeer::NUM_COLUMNS - PurchaseOrderPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(PurchaseOrderPeer::ID) ) {
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		$result = array(
			...
			$keys[4] => $this->getDatePaid(),
			$keys[5] => $this->getIsActive(),
			$keys[6] => $this->getIsPaid(),
		);
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setDatePaid($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setIsActive($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setIsPaid($arr[$keys[6]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PurchaseOrderPeer::USER_ID)) $criteria->add(PurchaseOrderPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(PurchaseOrderPeer::DESCRIPTION)) $criteria->add(PurchaseOrderPeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(PurchaseOrderPeer::DATE_CREATED)) $criteria->add(PurchaseOrderPeer::DATE_CREATED, $this->date_created);
		if ($this->isColumnModified(PurchaseOrderPeer::DATE_PAID)) $criteria->add(PurchaseOrderPeer::DATE_PAID, $this->date_paid);
		if ($this->isColumnModified(PurchaseOrderPeer::IS_ACTIVE)) $criteria->add(PurchaseOrderPeer::IS_ACTIVE, $this->is_active);
		if ($this->isColumnModified(PurchaseOrderPeer::IS_PAID)) $criteria->add(PurchaseOrderPeer::IS_PAID, $this->is_paid);
	...
	public function getUser(PropelPDO $con = null)
	{
		if ($this->aUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
				 ...
				 $this->aUser->addPurchaseOrders($this);
			 */
		}
		return $this->aUser;
	}
	 ...
	 * @return     PropelCollection|array PurchaseDetail[] List of PurchaseDetail objects
	 */
	public function getPurchaseDetailsJoinDeal($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = PurchaseDetailQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array PurchaseOrderChange[] List of PurchaseOrderChange objects
	 */
	public function getPurchaseOrderChangesJoinCredit($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = PurchaseOrderChangeQuery::create(null, $criteria);
		$query->joinWith('Credit', $join_behavior);
