...
abstract class BaseCategoryPeer {
	...
	const CLASS_DEFAULT = 'komideals.Category';
	...
	const DATE_CREATED = 'category.DATE_CREATED';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ParentId', 'CategoryName', 'DateCreated', 'IsActive', 'Slug', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'parentId', 'categoryName', 'dateCreated', 'isActive', 'slug', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PARENT_ID, self::CATEGORY_NAME, self::DATE_CREATED, self::IS_ACTIVE, self::SLUG, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PARENT_ID', 'CATEGORY_NAME', 'DATE_CREATED', 'IS_ACTIVE', 'SLUG', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'parent_id', 'category_name', 'date_created', 'is_active', 'slug', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ParentId' => 1, 'CategoryName' => 2, 'DateCreated' => 3, 'IsActive' => 4, 'Slug' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'parentId' => 1, 'categoryName' => 2, 'dateCreated' => 3, 'isActive' => 4, 'slug' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PARENT_ID => 1, self::CATEGORY_NAME => 2, self::DATE_CREATED => 3, self::IS_ACTIVE => 4, self::SLUG => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'PARENT_ID' => 1, 'CATEGORY_NAME' => 2, 'DATE_CREATED' => 3, 'IS_ACTIVE' => 4, 'SLUG' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'parent_id' => 1, 'category_name' => 2, 'date_created' => 3, 'is_active' => 4, 'slug' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(CategoryPeer::DATE_CREATED);
