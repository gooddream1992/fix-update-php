 ...
 *
 * @method     AffiliatePaymentDetailQuery leftJoinDealFeedCommission($relationAlias = null) Adds a LEFT JOIN clause to the query using the DealFeedCommission relation
 * @method     AffiliatePaymentDetailQuery rightJoinDealFeedCommission($relationAlias = null) Adds a RIGHT JOIN clause to the query using the DealFeedCommission relation
 * @method     AffiliatePaymentDetailQuery innerJoinDealFeedCommission($relationAlias = null) Adds a INNER JOIN clause to the query using the DealFeedCommission relation
 *
...
abstract class BaseAffiliatePaymentDetailQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'komideals', $modelName = 'AffiliatePaymentDetail', $modelAlias = null)
	{
	...
	{
		return $this
			->addUsingAlias(AffiliatePaymentDetailPeer::DEAL_FEED_COMMISSION_ID, $dealFeedCommission->getId(), $comparison);
	}
