...
abstract class BaseTaxonomyDmoz extends BaseObject  implements Persistent
{
	 ...
	 * Otherwise if this TaxonomyDmoz is new, it will return
	 * an empty collection; or if this TaxonomyDmoz has previously
	 * been saved, it will retrieve related DealFeedTaxonomyDmozs from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in TaxonomyDmoz.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 ...
	 * @return     PropelCollection|array DealFeedTaxonomyDmoz[] List of DealFeedTaxonomyDmoz objects
	 */
	public function getDealFeedTaxonomyDmozsJoinDealFeed($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = DealFeedTaxonomyDmozQuery::create(null, $criteria);
