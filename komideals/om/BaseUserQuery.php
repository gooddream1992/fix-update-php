 ...
 *
 * @method     UserQuery leftJoinDealFeedThread($relationAlias = null) Adds a LEFT JOIN clause to the query using the DealFeedThread relation
 * @method     UserQuery rightJoinDealFeedThread($relationAlias = null) Adds a RIGHT JOIN clause to the query using the DealFeedThread relation
 * @method     UserQuery innerJoinDealFeedThread($relationAlias = null) Adds a INNER JOIN clause to the query using the DealFeedThread relation
 *
...
abstract class BaseUserQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'komideals', $modelName = 'User', $modelAlias = null)
	{
	...
	{
		return $this
			->addUsingAlias(UserPeer::ID, $dealFeedThread->getUserId(), $comparison);
	}
