 ...
 *
 * @method     PricingModelQuery leftJoinDeal($relationAlias = null) Adds a LEFT JOIN clause to the query using the Deal relation
 * @method     PricingModelQuery rightJoinDeal($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Deal relation
 * @method     PricingModelQuery innerJoinDeal($relationAlias = null) Adds a INNER JOIN clause to the query using the Deal relation
 *
...
abstract class BasePricingModelQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'komideals', $modelName = 'PricingModel', $modelAlias = null)
	{
	...
	{
		return $this
			->addUsingAlias(PricingModelPeer::ID, $deal->getPricingModelId(), $comparison);
	}
