...
abstract class BasePurchaseDetail extends BaseObject  implements Persistent
{
	...
	public function setPurchaseOrderId($v)
	{
		...
		if ($this->purchase_order_id !== $v || $this->isNew()) {
			...
			$this->modifiedColumns[] = PurchaseDetailPeer::PURCHASE_ORDER_ID;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v || $this->isNew()) {
			$this->description = $v;
			$this->modifiedColumns[] = PurchaseDetailPeer::DESCRIPTION;
		}
	...
	public function setDateCreated($v)
	{
		...
		if ( $this->date_created !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PurchaseDetailPeer::DATE_CREATED;
			}
	...
	public function setIsActive($v)
	{
		...
		if ($this->is_active !== $v || $this->isNew()) {
			$this->is_active = $v;
			$this->modifiedColumns[] = PurchaseDetailPeer::IS_ACTIVE;
		}
	...
	public function setDealId($v)
	{
		...
		if ($this->deal_id !== $v || $this->isNew()) {
			$this->deal_id = $v;
			$this->modifiedColumns[] = PurchaseDetailPeer::DEAL_ID;
		}
	...
	public function setAmount($v)
	{
		...
		if ($this->amount !== $v || $this->isNew()) {
			$this->amount = $v;
			$this->modifiedColumns[] = PurchaseDetailPeer::AMOUNT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->purchase_order_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			...
			$this->deal_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			...
			return $startcol + 7; // 7 = PurchaseDetailPeer::NUM_COLUMNS - PurchaseDetailPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(PurchaseDetailPeer::ID) ) {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setPurchaseOrderId($arr[$keys[1]]);
		...
		if (array_key_exists($keys[5], $arr)) $this->setDealId($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PurchaseDetailPeer::PURCHASE_ORDER_ID)) $criteria->add(PurchaseDetailPeer::PURCHASE_ORDER_ID, $this->purchase_order_id);
		if ($this->isColumnModified(PurchaseDetailPeer::DESCRIPTION)) $criteria->add(PurchaseDetailPeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(PurchaseDetailPeer::DATE_CREATED)) $criteria->add(PurchaseDetailPeer::DATE_CREATED, $this->date_created);
		if ($this->isColumnModified(PurchaseDetailPeer::IS_ACTIVE)) $criteria->add(PurchaseDetailPeer::IS_ACTIVE, $this->is_active);
		if ($this->isColumnModified(PurchaseDetailPeer::DEAL_ID)) $criteria->add(PurchaseDetailPeer::DEAL_ID, $this->deal_id);
		if ($this->isColumnModified(PurchaseDetailPeer::AMOUNT)) $criteria->add(PurchaseDetailPeer::AMOUNT, $this->amount);
	...
	public function getDeal(PropelPDO $con = null)
	{
		if ($this->aDeal === null && ($this->deal_id !== null)) {
			...
			/* The following can be used additionally to
				 ...
				 $this->aDeal->addPurchaseDetails($this);
			 */
		}
		return $this->aDeal;
	}
	...
	public function getPurchaseOrder(PropelPDO $con = null)
	{
		if ($this->aPurchaseOrder === null && ($this->purchase_order_id !== null)) {
			...
			/* The following can be used additionally to
				 ...
				 undesirable since it could result in an only partially populated collection
				 in the referenced object.
				 $this->aPurchaseOrder->addPurchaseDetails($this);
			 */
		}
