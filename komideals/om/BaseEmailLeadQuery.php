 ...
 * @method     EmailLeadQuery orderByLatitude($order = Criteria::ASC) Order by the latitude column
 * @method     EmailLeadQuery orderByLongitude($order = Criteria::ASC) Order by the longitude column
 *
 ...
 * @method     EmailLeadQuery groupByLatitude() Group by the latitude column
 * @method     EmailLeadQuery groupByLongitude() Group by the longitude column
 *
 ...
 * @method     EmailLead findOneByLatitude(double $latitude) Return the first EmailLead filtered by the latitude column
 * @method     EmailLead findOneByLongitude(double $longitude) Return the first EmailLead filtered by the longitude column
 *
 ...
 * @method     array findByLatitude(double $latitude) Return EmailLead objects filtered by the latitude column
 * @method     array findByLongitude(double $longitude) Return EmailLead objects filtered by the longitude column
 *
...
abstract class BaseEmailLeadQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'komideals', $modelName = 'EmailLead', $modelAlias = null)
	{
	...
	public function filterByLatitude($latitude = null, $comparison = null)
	{
		if (is_array($latitude)) {
			...
			if (isset($latitude['min'])) {
				$this->addUsingAlias(EmailLeadPeer::LATITUDE, $latitude['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($latitude['max'])) {
				$this->addUsingAlias(EmailLeadPeer::LATITUDE, $latitude['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(EmailLeadPeer::LATITUDE, $latitude, $comparison);
	}
	...
	public function filterByLongitude($longitude = null, $comparison = null)
	{
		if (is_array($longitude)) {
			...
			if (isset($longitude['min'])) {
				$this->addUsingAlias(EmailLeadPeer::LONGITUDE, $longitude['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($longitude['max'])) {
				$this->addUsingAlias(EmailLeadPeer::LONGITUDE, $longitude['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(EmailLeadPeer::LONGITUDE, $longitude, $comparison);
	}
