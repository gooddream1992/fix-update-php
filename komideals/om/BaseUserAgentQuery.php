 ...
 *
 * @method     UserAgentQuery leftJoinDealFeedClick($relationAlias = null) Adds a LEFT JOIN clause to the query using the DealFeedClick relation
 * @method     UserAgentQuery rightJoinDealFeedClick($relationAlias = null) Adds a RIGHT JOIN clause to the query using the DealFeedClick relation
 * @method     UserAgentQuery innerJoinDealFeedClick($relationAlias = null) Adds a INNER JOIN clause to the query using the DealFeedClick relation
 *
 * @method     UserAgentQuery leftJoinDealFeedView($relationAlias = null) Adds a LEFT JOIN clause to the query using the DealFeedView relation
 * @method     UserAgentQuery rightJoinDealFeedView($relationAlias = null) Adds a RIGHT JOIN clause to the query using the DealFeedView relation
 * @method     UserAgentQuery innerJoinDealFeedView($relationAlias = null) Adds a INNER JOIN clause to the query using the DealFeedView relation
 *
...
abstract class BaseUserAgentQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'komideals', $modelName = 'UserAgent', $modelAlias = null)
	{
	...
	{
		return $this
			->addUsingAlias(UserAgentPeer::ID, $dealFeedClick->getUserAgentId(), $comparison);
	}
	...
	{
		return $this
			->addUsingAlias(UserAgentPeer::ID, $dealFeedView->getUserAgentId(), $comparison);
	}
