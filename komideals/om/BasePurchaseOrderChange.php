...
/**
 * Base class that represents a row from the 'purchase_order_change' table.
 *
 * 
 *
 * @package    propel.generator.komideals.om
 */
abstract class BasePurchaseOrderChange extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'PurchaseOrderChangePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        PurchaseOrderChangePeer
	 */
	...
	/**
	 * Initializes internal state of BasePurchaseOrderChange object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     PurchaseOrderChange The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PurchaseOrderChangePeer::ID;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v || $this->isNew()) {
			$this->description = $v;
			$this->modifiedColumns[] = PurchaseOrderChangePeer::DESCRIPTION;
		}
	...
	public function setDateCreated($v)
	{
		...
		if ( $this->date_created !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PurchaseOrderChangePeer::DATE_CREATED;
			}
	...
	public function setIsActive($v)
	{
		...
		if ($this->is_active !== $v || $this->isNew()) {
			$this->is_active = $v;
			$this->modifiedColumns[] = PurchaseOrderChangePeer::IS_ACTIVE;
		}
	...
	public function setPurchaseOrderId($v)
	{
		...
		if ($this->purchase_order_id !== $v || $this->isNew()) {
			...
			$this->modifiedColumns[] = PurchaseOrderChangePeer::PURCHASE_ORDER_ID;
		}
	...
	public function setCreditId($v)
	{
		...
		if ($this->credit_id !== $v || $this->isNew()) {
			$this->credit_id = $v;
			$this->modifiedColumns[] = PurchaseOrderChangePeer::CREDIT_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->purchase_order_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->credit_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->resetModified();
			...
			return $startcol + 6; // 6 = PurchaseOrderChangePeer::NUM_COLUMNS - PurchaseOrderChangePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating PurchaseOrderChange object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = PurchaseOrderChangePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				PurchaseOrderChangeQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				PurchaseOrderChangePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(PurchaseOrderChangePeer::ID) ) {
					...
					$affectedRows += PurchaseOrderChangePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PurchaseOrderChangePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PurchaseOrderChangePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = PurchaseOrderChangePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getDescription(),
			$keys[2] => $this->getDateCreated(),
			$keys[3] => $this->getIsActive(),
			$keys[4] => $this->getPurchaseOrderId(),
			$keys[5] => $this->getCreditId(),
		);
		if ($includeForeignObjects) {
			if (null !== $this->aCredit) {
				$result['Credit'] = $this->aCredit->toArray($keyType, $includeLazyLoadColumns, true);
			}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setPurchaseOrderId($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setCreditId($arr[$keys[5]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PurchaseOrderChangePeer::ID)) $criteria->add(PurchaseOrderChangePeer::ID, $this->id);
		if ($this->isColumnModified(PurchaseOrderChangePeer::DESCRIPTION)) $criteria->add(PurchaseOrderChangePeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(PurchaseOrderChangePeer::DATE_CREATED)) $criteria->add(PurchaseOrderChangePeer::DATE_CREATED, $this->date_created);
		if ($this->isColumnModified(PurchaseOrderChangePeer::IS_ACTIVE)) $criteria->add(PurchaseOrderChangePeer::IS_ACTIVE, $this->is_active);
		if ($this->isColumnModified(PurchaseOrderChangePeer::PURCHASE_ORDER_ID)) $criteria->add(PurchaseOrderChangePeer::PURCHASE_ORDER_ID, $this->purchase_order_id);
		if ($this->isColumnModified(PurchaseOrderChangePeer::CREDIT_ID)) $criteria->add(PurchaseOrderChangePeer::CREDIT_ID, $this->credit_id);
	...
	{
		$criteria = new Criteria(PurchaseOrderChangePeer::DATABASE_NAME);
		$criteria->add(PurchaseOrderChangePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PurchaseOrderChange (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PurchaseOrderChange Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     PurchaseOrderChangePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new PurchaseOrderChangePeer();
		}
		return self::$peer;
	}
	...
	{
		if ($this->aCredit === null && ($this->credit_id !== null)) {
			$this->aCredit = CreditQuery::create()->findPk($this->credit_id, $con);
			/* The following can be used additionally to
				 guarantee the related object contains a reference
				 to this object.  This level of coupling may, however, be
				 undesirable since it could result in an only partially populated collection
				 in the referenced object.
				 $this->aCredit->addPurchaseOrderChanges($this);
			 */
		}
		return $this->aCredit;
	}
	...
	public function getPurchaseOrder(PropelPDO $con = null)
	{
		if ($this->aPurchaseOrder === null && ($this->purchase_order_id !== null)) {
			...
			/* The following can be used additionally to
				 ...
				 undesirable since it could result in an only partially populated collection
				 in the referenced object.
				 $this->aPurchaseOrder->addPurchaseOrderChanges($this);
			 */
		}
