...
abstract class BaseEmailTemplate extends BaseObject  implements Persistent
{
	...
	public function setSubject($v)
	{
		...
		if ($this->subject !== $v || $this->isNew()) {
			$this->subject = $v;
			$this->modifiedColumns[] = EmailTemplatePeer::SUBJECT;
		}
	...
	public function setBody($v)
	{
		...
		if ($this->body !== $v) {
			$this->body = $v;
			$this->modifiedColumns[] = EmailTemplatePeer::BODY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = EmailTemplatePeer::NUM_COLUMNS - EmailTemplatePeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(EmailTemplatePeer::ID) ) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EmailTemplatePeer::SUBJECT)) $criteria->add(EmailTemplatePeer::SUBJECT, $this->subject);
		if ($this->isColumnModified(EmailTemplatePeer::BODY)) $criteria->add(EmailTemplatePeer::BODY, $this->body);
