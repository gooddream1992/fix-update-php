...
abstract class BaseDomain extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the domain_extension field.
	 * Note: this column has a database default value of: ''
	 * @var        string
	 */
	...
	/**
	 * Get the [domain_extension] column value.
	 * 
	 * @return     string
	 */
	public function getDomainExtension()
	{
		return $this->domain_extension;
	}
	...
	public function setDomainName($v)
	{
		...
		if ($this->domain_name !== $v || $this->isNew()) {
			$this->domain_name = $v;
			$this->modifiedColumns[] = DomainPeer::DOMAIN_NAME;
		}
	...
	/**
	 * Set the value of [domain_extension] column.
	 * 
	 * @param      string $v new value
	 * @return     Domain The current object (for fluent API support)
	 */
	public function setDomainExtension($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->domain_extension !== $v || $this->isNew()) {
			$this->domain_extension = $v;
			$this->modifiedColumns[] = DomainPeer::DOMAIN_EXTENSION;
		}
	...
	public function setResult($v)
	{
		...
		if ($this->result !== $v) {
			$this->result = $v;
			$this->modifiedColumns[] = DomainPeer::RESULT;
		}
	...
	public function setDateCreated($v)
	{
		...
		if ( $this->date_created !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = DomainPeer::DATE_CREATED;
			}
	...
	public function setDateModified($v)
	{
		...
		if ( $this->date_modified !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = DomainPeer::DATE_MODIFIED;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->domain_extension = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 6; // 6 = DomainPeer::NUM_COLUMNS - DomainPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[2] => $this->getDomainExtension(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setDomainExtension($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DomainPeer::DOMAIN_NAME)) $criteria->add(DomainPeer::DOMAIN_NAME, $this->domain_name);
		if ($this->isColumnModified(DomainPeer::DOMAIN_EXTENSION)) $criteria->add(DomainPeer::DOMAIN_EXTENSION, $this->domain_extension);
		if ($this->isColumnModified(DomainPeer::RESULT)) $criteria->add(DomainPeer::RESULT, $this->result);
		if ($this->isColumnModified(DomainPeer::DATE_CREATED)) $criteria->add(DomainPeer::DATE_CREATED, $this->date_created);
		if ($this->isColumnModified(DomainPeer::DATE_MODIFIED)) $criteria->add(DomainPeer::DATE_MODIFIED, $this->date_modified);
	...
	{
		$copyObj->setDomainName($this->domain_name);
		$copyObj->setDomainExtension($this->domain_extension);
