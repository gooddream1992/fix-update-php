...
abstract class BaseDomainPeer {
	...
	const CLASS_DEFAULT = 'komideals.Domain';
	...
	/** the column name for the DOMAIN_EXTENSION field */
	const DOMAIN_EXTENSION = 'domain.DOMAIN_EXTENSION';

	/** the column name for the RESULT field */
	const RESULT = 'domain.RESULT';

	/** the column name for the DATE_CREATED field */
	const DATE_CREATED = 'domain.DATE_CREATED';

	/** the column name for the DATE_MODIFIED field */
	const DATE_MODIFIED = 'domain.DATE_MODIFIED';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'DomainName', 'DomainExtension', 'Result', 'DateCreated', 'DateModified', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'domainName', 'domainExtension', 'result', 'dateCreated', 'dateModified', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::DOMAIN_NAME, self::DOMAIN_EXTENSION, self::RESULT, self::DATE_CREATED, self::DATE_MODIFIED, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DOMAIN_NAME', 'DOMAIN_EXTENSION', 'RESULT', 'DATE_CREATED', 'DATE_MODIFIED', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'domain_name', 'domain_extension', 'result', 'date_created', 'date_modified', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'DomainName' => 1, 'DomainExtension' => 2, 'Result' => 3, 'DateCreated' => 4, 'DateModified' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'domainName' => 1, 'domainExtension' => 2, 'result' => 3, 'dateCreated' => 4, 'dateModified' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::DOMAIN_NAME => 1, self::DOMAIN_EXTENSION => 2, self::RESULT => 3, self::DATE_CREATED => 4, self::DATE_MODIFIED => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DOMAIN_NAME' => 1, 'DOMAIN_EXTENSION' => 2, 'RESULT' => 3, 'DATE_CREATED' => 4, 'DATE_MODIFIED' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'domain_name' => 1, 'domain_extension' => 2, 'result' => 3, 'date_created' => 4, 'date_modified' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(DomainPeer::DOMAIN_NAME);
			$criteria->addSelectColumn(DomainPeer::DOMAIN_EXTENSION);
			$criteria->addSelectColumn(DomainPeer::RESULT);
			$criteria->addSelectColumn(DomainPeer::DATE_CREATED);
			$criteria->addSelectColumn(DomainPeer::DATE_MODIFIED);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.DOMAIN_NAME');
			$criteria->addSelectColumn($alias . '.DOMAIN_EXTENSION');
