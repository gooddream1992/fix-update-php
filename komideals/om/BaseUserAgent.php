...
abstract class BaseUserAgent extends BaseObject  implements Persistent
{
	 ...
	 * If this UserAgent is new, it will return
	 ...
	 * Otherwise if this UserAgent is new, it will return
	 * an empty collection; or if this UserAgent has previously
	 * been saved, it will retrieve related DealFeedClicks from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in UserAgent.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 ...
	 * @return     PropelCollection|array DealFeedView[] List of DealFeedView objects
	 */
	public function getDealFeedViewsJoinBusiness($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = DealFeedViewQuery::create(null, $criteria);
		$query->joinWith('Business', $join_behavior);
