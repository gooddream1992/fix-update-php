...
abstract class BasePurchaseDetailPeer {
	...
	const CLASS_DEFAULT = 'komideals.PurchaseDetail';
	...
	public static function doCountJoinDeal(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(PurchaseDetailPeer::DEAL_ID, DealPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of PurchaseDetail objects pre-filled with their Deal objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinDeal(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (PurchaseDetail) to $obj2 (Deal)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (PurchaseDetail) to the collection in $obj2 (Deal)
				$obj2->addPurchaseDetail($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (PurchaseDetail) to the collection in $obj3 (PurchaseOrder)
	...
	/**
	 * Selects a collection of PurchaseDetail objects pre-filled with all related objects except Deal.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of PurchaseDetail objects pre-filled with all related objects except PurchaseOrder.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
