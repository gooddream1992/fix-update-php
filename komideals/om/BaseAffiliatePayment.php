...
abstract class BaseAffiliatePayment extends BaseObject  implements Persistent
{
	 ...
	 * Otherwise if this AffiliatePayment is new, it will return
	 * an empty collection; or if this AffiliatePayment has previously
	 * been saved, it will retrieve related AffiliatePaymentDetails from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in AffiliatePayment.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 ...
	 * @return     PropelCollection|array AffiliatePaymentDetail[] List of AffiliatePaymentDetail objects
	 */
	public function getAffiliatePaymentDetailsJoinDealFeedCommission($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = AffiliatePaymentDetailQuery::create(null, $criteria);
		$query->joinWith('DealFeedCommission', $join_behavior);
