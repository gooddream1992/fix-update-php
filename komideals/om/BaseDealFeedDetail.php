...
/**
 * Base class that represents a row from the 'deal_feed_detail' table.
 *
 * 
 *
 * @package    propel.generator.komideals.om
 */
abstract class BaseDealFeedDetail extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'DealFeedDetailPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        DealFeedDetailPeer
	 */
	...
	/**
	 * Initializes internal state of BaseDealFeedDetail object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     DealFeedDetail The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = DealFeedDetailPeer::ID;
		}
	...
	public function setDealFeedId($v)
	{
		...
		if ($this->deal_feed_id !== $v || $this->isNew()) {
			$this->deal_feed_id = $v;
			$this->modifiedColumns[] = DealFeedDetailPeer::DEAL_FEED_ID;
		}
	...
	public function setContent($v)
	{
		...
		if ($this->content !== $v) {
			$this->content = $v;
			$this->modifiedColumns[] = DealFeedDetailPeer::CONTENT;
		}
	...
	public function setDateCreated($v)
	{
		...
		if ( $this->date_created !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = DealFeedDetailPeer::DATE_CREATED;
			}
	...
	public function setIsActive($v)
	{
		...
		if ($this->is_active !== $v || $this->isNew()) {
			$this->is_active = $v;
			$this->modifiedColumns[] = DealFeedDetailPeer::IS_ACTIVE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = DealFeedDetailPeer::NUM_COLUMNS - DealFeedDetailPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating DealFeedDetail object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = DealFeedDetailPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				DealFeedDetailPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(DealFeedDetailPeer::ID) ) {
					...
					$affectedRows += DealFeedDetailPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = DealFeedDetailPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = DealFeedDetailPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = DealFeedDetailPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DealFeedDetailPeer::ID)) $criteria->add(DealFeedDetailPeer::ID, $this->id);
		if ($this->isColumnModified(DealFeedDetailPeer::DEAL_FEED_ID)) $criteria->add(DealFeedDetailPeer::DEAL_FEED_ID, $this->deal_feed_id);
		if ($this->isColumnModified(DealFeedDetailPeer::CONTENT)) $criteria->add(DealFeedDetailPeer::CONTENT, $this->content);
		if ($this->isColumnModified(DealFeedDetailPeer::DATE_CREATED)) $criteria->add(DealFeedDetailPeer::DATE_CREATED, $this->date_created);
		if ($this->isColumnModified(DealFeedDetailPeer::IS_ACTIVE)) $criteria->add(DealFeedDetailPeer::IS_ACTIVE, $this->is_active);
	...
	{
		$criteria = new Criteria(DealFeedDetailPeer::DATABASE_NAME);
		$criteria->add(DealFeedDetailPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of DealFeedDetail (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     DealFeedDetail Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     DealFeedDetailPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new DealFeedDetailPeer();
		}
		return self::$peer;
	}
	...
	public function getDealFeed(PropelPDO $con = null)
	{
		if ($this->aDealFeed === null && ($this->deal_feed_id !== null)) {
			...
			/* The following can be used additionally to
				 ...
				 $this->aDealFeed->addDealFeedDetails($this);
			 */
		}
