...
class AffiliatePaymentDetailTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'komideals.map.AffiliatePaymentDetailTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('DEAL_FEED_COMMISSION_ID', 'DealFeedCommissionId', 'INTEGER', 'deal_feed_commission', 'ID', true, 10, null);
    ...
    $this->addRelation('DealFeedCommission', 'DealFeedCommission', RelationMap::MANY_TO_ONE, array('deal_feed_commission_id' => 'id', ), 'RESTRICT', 'RESTRICT');
	} // buildRelations()
