...
class CategoryTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'komideals.map.CategoryTableMap';
    ...
    $this->addRelation('Deal', 'Deal', RelationMap::ONE_TO_MANY, array('id' => 'category_id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('DealFeed', 'DealFeed', RelationMap::ONE_TO_MANY, array('id' => 'category_id', ), 'RESTRICT', 'RESTRICT');
	} // buildRelations()
