...
/**
 * This class defines the structure of the 'deal_feed_click' table.
 *
 *
 *
 ...
 */
class DealFeedClickTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'komideals.map.DealFeedClickTableMap';
	...
	{
	  // attributes
		$this->setName('deal_feed_click');
		$this->setPhpName('DealFeedClick');
		$this->setClassname('DealFeedClick');
		...
		$this->addColumn('HTTP_REFERER', 'HttpReferer', 'VARCHAR', true, 512, null);
		$this->addColumn('REMOTE_ADDR', 'RemoteAddr', 'VARCHAR', true, 32, null);
		$this->addColumn('SID', 'Sid', 'VARCHAR', true, 32, '');
		$this->addColumn('HTTP_REFERER2', 'HttpReferer2', 'VARCHAR', true, 512, null);
		// validators
	} // initialize()
