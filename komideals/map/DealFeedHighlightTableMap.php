...
/**
 * This class defines the structure of the 'deal_feed_highlight' table.
 *
 *
 *
 ...
 */
class DealFeedHighlightTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'komideals.map.DealFeedHighlightTableMap';
	...
	{
	  // attributes
		$this->setName('deal_feed_highlight');
		$this->setPhpName('DealFeedHighlight');
		$this->setClassname('DealFeedHighlight');
