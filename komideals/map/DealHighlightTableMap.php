...
/**
 * This class defines the structure of the 'deal_highlight' table.
 *
 *
 *
 ...
 */
class DealHighlightTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'komideals.map.DealHighlightTableMap';
	...
	{
	  // attributes
		$this->setName('deal_highlight');
		$this->setPhpName('DealHighlight');
		$this->setClassname('DealHighlight');
