...
/**
 * Skeleton subclass for representing a row from the 'deal_feed_taxonomy_dmoz' table.
 *
 * 
 *
 ...
 */
class DealFeedTaxonomyDmoz extends BaseDealFeedTaxonomyDmoz {
